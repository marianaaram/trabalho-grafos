...
public class main {
    public static void main(String[] args) throws Exception {
        ...
        switch (EDirecionado) {
          ...
          System.out.println("Um grafo não direcionado e não ponderado com " + numVertices + " vértices foi criado usando Matriz e Lista de Adjacência.\n" );
          ...
          case 2:
          LimparTela.limpar_console();
          System.out.println("Um grafo nao direcionado e ponderado com " + numVertices + " vértices foi criado usando Matriz e Lista de Adjacência.\n" );
          ...
          case 2:
            switch(EPonderado){
              ...
              case 1:
              LimparTela.limpar_console();
          System.out.println("Um grafo direcionado não ponderado com " + numVertices + " vértices foi criado usando Matriz e Lista de Adjacência.\n"); 
          ...
          LimparTela.limpar_console();
          System.out.println("Um grafo direcionado ponderado com " + numVertices + " vértices foi criado usando Matriz e Lista de Adjacência.\n"); 
          ...
          do{
            ...
            switch (num) {
              ...
              case 4:
                ...
                System.out.println("\nO grau de entrada do vértice "+verticeGrau+" é: "+ grafoMatrizAdj.grauEntrada(verticeGrau));
                System.out.println("O grau de saída do vértice "+verticeGrau+" é: "+ grafoMatrizAdj.grauVertice(verticeGrau));
